...
export const Footer: React.FC = () => {
  return (
    <footer className="mt-auto border-t border-white/50 dark:border-white/10 bg-[#fbf9f8]/60 dark:bg-[#0e1015]/80 backdrop-blur-md py-8 px-6 md:px-12 font-body text-xs text-[#5b403e] dark:text-[#9ca3af]">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-2">
          <span className="font-bold text-[#1b1c1c] dark:text-[#f9fafb] text-sm tracking-tight">LUMINA</span>
          <span>•</span>
